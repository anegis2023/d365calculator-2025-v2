...
const KontaktPage: React.FC = () => {
  ...
  const emptyModuleSelections: ModuleSelection[] = [];
  const location = useLocation();
  const metaTags = getPageMetaData(location.pathname.substring(1));
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await submitForm({
        ...formData,
        moduleSelections: emptyModuleSelections,
        totalPrice: 0
      });
    ...
    <div className="min-h-screen bg-[#faf9f8]">
      ...
      <div className="container mx-auto px-4 py-8 pt-16">
        <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8 max-w-2xl mx-auto">
          <div className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-2">Formularz kontaktowy</h2>
            <p className="text-gray-600">Wdrażamy systemy ERP, naprawiamy nieudane projekty, uczymy klientów poruszać się w środowisku Microsoft Dynamics 365 – jesteśmy do Państwa dyspozycji.</p>
          </div>
