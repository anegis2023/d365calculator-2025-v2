    ...
    <div className="relative overflow-hidden bg-[#071630] text-white">
      ...
      <div className="absolute right-0 top-0 w-1/2 h-full">
        <div className="absolute right-0 top-0 w-full h-full">
          <div className="absolute right-[-10%] top-[-10%] w-[120%] h-[120%] rounded-full bg-gradient-to-br from-[#071630] via-[#00a2ed] to-[#ffb900] opacity-30 blur-3xl"></div>
        </div>
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        <div className="max-w-2xl">
          <h1 className="text-4xl sm:text-5xl font-semibold mb-6">
            Kalkulator licencji<br />Microsoft Dynamics 365
          </h1>
          <p className="text-xl mb-8 text-white/90">
            Rozwijaj swoją firmę dzięki inteligentnym rozwiązaniom CRM i ERP wspieranym przez Microsoft.
          </p>
